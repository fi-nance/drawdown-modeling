...
import { computeFederalDeductionChoice, computeIncomeTax } from "../tax.mjs?v=20260613-tips-coupon";
...
import { acaMagiForIncome, incomeForYear, irmaaMagiForIncome } from "./income.mjs?v=20260613-tips-coupon";
