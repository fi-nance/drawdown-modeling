...
import { computeFederalDeductionChoice, computeIncomeTax } from "../tax.mjs?v=20260613-rescue-precision";
...
import { acaMagiForIncome, incomeForYear, irmaaMagiForIncome } from "./income.mjs?v=20260613-rescue-precision";
