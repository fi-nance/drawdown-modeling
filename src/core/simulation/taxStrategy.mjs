...
import { computeFederalDeductionChoice, computeIncomeTax } from "../tax.mjs?v=20260604-qbi";
...
import { acaMagiForIncome, incomeForYear, irmaaMagiForIncome } from "./income.mjs?v=20260604-qbi";
