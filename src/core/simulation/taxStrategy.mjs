...
import { computeFederalDeductionChoice, computeIncomeTax } from "../tax.mjs?v=20260613-portfolio-prices";
...
import { acaMagiForIncome, incomeForYear, irmaaMagiForIncome } from "./income.mjs?v=20260613-portfolio-prices";
