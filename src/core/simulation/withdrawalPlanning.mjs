...
import { computeIncomeTax } from "../tax.mjs?v=20260613-rescue-precision";
...
import { acaMagiForIncome, federalAgiForIncome, incomeForYear, irmaaMagiForIncome } from "./income.mjs?v=20260613-rescue-precision";
...
import { addPenaltyTax, estimatedFutureCapitalGainRate, estimatedFutureOrdinaryIncomeRate } from "./taxStrategy.mjs?v=20260613-rescue-precision";
