...
import { DEFAULT_TAX_PROFILE } from "../tax.mjs?v=20260613-portfolio-prices";
...
import { normalizeLossCarryforward } from "./income.mjs?v=20260613-portfolio-prices";
import {
  annualInflation,
...
import { buildPostMortalityYearResult, simulateYear } from "./yearEngine.mjs?v=20260613-portfolio-prices";
