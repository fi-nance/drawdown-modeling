...
import { DEFAULT_TAX_PROFILE } from "../tax.mjs?v=20260604-itemized";
...
import { normalizeLossCarryforward } from "./income.mjs?v=20260604-itemized";
...
import { buildPostMortalityYearResult, simulateYear } from "./yearEngine.mjs?v=20260604-itemized";
