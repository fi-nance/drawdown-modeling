...
- [Not planning to address]: Detailed inherited-account and estate rules are not modeled. The app now estimates after-tax bequest with a single heir ordinary tax rate and taxable step-up assumption, but inherited IRA 5-year/10-year payout timing, eligible designated beneficiary rules, spouse elections, trust beneficiaries, missed-RMD excise tax handling, estate tax, and state inheritance tax remain out of scope.
