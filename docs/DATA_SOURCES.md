...
| --- | --- | --- | --- |
| Federal tax, ACA, FPL, ACA premium defaults | `src/data/taxData.mjs` | `TAX_DATA_VERSION = "2026.2"` | 2026 tax-law year |
...
- Federal tax currently models the standard deduction, age-65 additional standard deduction, progressive ordinary income tax, preferential long-term capital gain and qualified dividend stacking, dynamic child tax credit counts from child ages, Social Security taxable-benefit phase-in, NIIT, Additional Medicare Tax on explicit earned-income inputs, self-employment tax with the 2026 Schedule SE wage-base mechanics, capital-loss offsets and carryforwards, and manual additional deduction/credit overrides.
