...
| Inherited property basis and inherited IRA beneficiary rules | IRS Publication 559, Basis of Inherited Property: https://www.irs.gov/publications/p559/index.html; IRS Publication 590-B, inherited IRA 10-year rule: https://www.irs.gov/publications/p590b | `heirValueBreakdown`, `scenario.heirOrdinaryTaxRate`, legacy confidence flags | Verify when estate/inheritance modeling expands or IRS updates beneficiary distribution guidance |
...
- After-tax bequest modeling is deliberately narrow. `heirValueBreakdown` taxes ending traditional and HSA balances at `scenario.heirOrdinaryTaxRate`, treats Roth balances as tax-free to heirs, and assumes taxable-account unrealized gains receive a basis step-up at death. Inherited IRA 10-year payout timing, eligible designated beneficiary rules, trusts, estate/inheritance tax, and heir-specific brackets remain CPA/estate-review flags rather than modeled rules.
