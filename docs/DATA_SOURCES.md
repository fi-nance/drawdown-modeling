...
| --- | --- | --- | --- |
| Federal tax, ACA, FPL, ACA premium defaults | `src/data/taxData.mjs` | `TAX_DATA_VERSION = "2026.3"` | 2026 tax-law year |
...
| Social Security benefit taxation, claiming scaling, and PIA estimation | IRS Publication 915: https://www.irs.gov/publications/p915; SSA claiming age reductions/credits: https://www.ssa.gov/oact/quickcalc/early_late.html; SSA AIME-to-PIA bend points: https://www.ssa.gov/oact/cola/piaformula.html; SSA spousal benefits (no delayed-retirement credits): https://www.ssa.gov/benefits/retirement/planner/applying7.html | `FEDERAL_TAX_2026.socialSecurityTaxation`, `socialSecurityScalingFactor`, claiming solvers | SS taxation thresholds are statutory/not indexed. Claiming reductions/credits modeled (FRA 67). Earnings→PIA estimation is **opt-in** (`estimateSocialSecurityFromEarnings`) and a coarse single-year proxy (bend points approximate SSA 2025 $1,226/$7,391). Spousal benefits capped at FRA (no delayed credits). |
