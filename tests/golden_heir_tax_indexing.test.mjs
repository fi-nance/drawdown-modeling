...
import { estimateHeirValueBreakdown } from "../src/core/simulation/heirEstate.mjs?v=20260613-rescue-precision";
import { simulatePlan } from "../src/core/simulation.mjs?v=20260613-rescue-precision";
